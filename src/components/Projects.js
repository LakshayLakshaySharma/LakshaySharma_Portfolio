      ...
      <div className="row">
          ...
          <div className="col-md-4">
            ...
            <div class="card" style={{ width: "18rem" }}>
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Hex Color Changer</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
          ...
          <div className="col-md-4">
            ...
            <div class="card" style={{ width: "18rem" }}>
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Change CSS</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
          ...
          <div className="col-md-4">
            ...
            <div class="card" style={{ width: "18rem" }}>
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Guess Random Number</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
        ...
        <div className="col-md-4">
          ...
          <div className="col-md-4">
            ...
            <div class="card" style={{ width: "18rem" }}>
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Parallax Effect</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
          ...
          <div className="col-md-4">
            ...
            <div class="card" style={{ width: "18rem" }}>
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Document Page</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
          ...
          <div className="col-md-4">
            ...
            <div class="card" style={{ width: "18rem" }}>
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Survay From</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
